  ...
  return (
    <div className="flex flex-col items-center p-4 min-h-screen bg-gray-50">
      ...
      <main className="flex flex-col items-center bg-white p-6 rounded-lg shadow-lg mt-6 w-full max-w-lg">
        ...
        <p className="text-lg font-semibold text-gray-800 mb-4">Tentativas Restantes: {remainingAttempts}</p>
        {!infiniteMode && <p className="text-lg font-semibold text-gray-800 mb-4">Tempo Restante: {timer}s</p>}
        {feedback && (
          <div
